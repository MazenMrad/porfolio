...
export function routeMeta(siteUrl: string = DEFAULT_SITE_URL): RouteMeta[] {
  ...
  const home: RouteMeta = {
    ...
    description:
      'Godot game programmer (Mazicore). I write the systems you feel in play. Shipped tower defense, turn-based combat, and inventory tooling in Godot 4 and GDScript.',
